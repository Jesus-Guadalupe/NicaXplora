      ...
      <div className='w-10/12 flex flex-col gap-8'>
        <div className="flex justify-center">
          <div className='flex flex-row rounded-full shadow-xl overflow-hidden'>
            ...
            <button onClick={onSwitch} className="w-full border-2 border-l-0 text-[#346530] hover:bg-[#cce8d4] py-3 px-6 font-semibold transition-colors">
              Transporte Urbano
            </button>
          </div>
        </div>
  ...
  return (
    <div className='w-full flex justify-center py-12'>
      <div className='w-10/12 flex flex-col gap-8'>
        <div className="flex justify-center">
          <div className='flex flex-row rounded-full shadow-xl overflow-hidden'>
            <button onClick={onSwitch} className="w-full border-2 border-r-0 text-[#346530] py-3 px-6 font-semibold hover:bg-[#cce8d4] transition-colors">
              Transporte Interdepartamental
            </button>
            <button className="w-full bg-[#346530] text-white py-3 px-6 font-semibold hover:bg-[#21441E] transition-colors">
              Transporte Urbano
        ...
        <div className='flex flex-col items-center'>
          ...
          <p className='text-xl font-light mt-2 text-center'>Conexiones directas entre las principales ciudades de Nicaragua</p>
        </div>
